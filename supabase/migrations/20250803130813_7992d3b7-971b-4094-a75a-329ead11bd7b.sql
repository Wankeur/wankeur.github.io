-- Create a sample tutorial without created_by (let it be null for now)
...
Welcome to this comprehensive tutorial on Siemens TIA Portal! In this guide, we''ll walk through everything you need to know to get started with automation programming.
...
Now let''s start with basic programming:
...
Here''s a simple example of a start/stop circuit:
